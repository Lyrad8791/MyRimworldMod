...
//                WindowOpen = false;
//            }
//            var availableTasks = DominationUtil.sexualBills;
...
//                        DominationUtil.AssignCommand(pawn, cmd);
//                    }
//                }
//            }
...
//            int queueLength = DominationUtil.GetSexualCommands(pawn).Count;
...
//                        DominationUtil.colonyPawns.Where(x => x.gender == Gender.Female && x.GetHashCode() != pawn.GetHashCode()).ToList();
